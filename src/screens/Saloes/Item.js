      ...
      <Div>
        <Profile>
          <Button onPress={onPress} underlayColor="transparent">
            <>
            <Icon name="person-circle-outline" size={60} color={COLORS.primaryDark} />
            <TextNome>{item.nome}</TextNome>
            </>          
          </Button>
          <Icon name="ellipsis-vertical" size={40} color="black" ></Icon>
        </Profile>
        ...
        <Container style={{ height: 300}}>
          <Swiper index={0} style={styles.wrapper}
            ...
            {item.imagens.map((image, index) => (
              ...
              <View style={styles.slide} key={index}>
                  <Image source={{ uri: image }} key={image} style={{ width: 280, height: 250, borderRadius: 15 }} />
              </View>
              </>
            ))}
        ...
        <Opcoes>
          <Botao onPress={() => handleButtonPress('menu')}
                  underlayColor="transparent"
                  active={activeButton === 'menu'}
              >
              <Icon name="menu" size={60} color="black"></Icon>
          </Botao>
          <Botao onPress={() => handleButtonPress('image')}
                underlayColor="transparent"
                active={activeButton === 'image'}
               >
              <Icon name="image" size={60} color="black" ></Icon>
          </Botao>
        </Opcoes>
      </Div>
    </>
